...
int main(void)
{
    ...
    // TODO: Változók inicializálása
    int* global_histogram =(int*)calloc(256,sizeof(int))
    ...
    // TODO: Bufferek beállítása
    cl_mem device_global_histogram = clCreateBuffer(context, CL_MEM_READ_WRITE, 256 *sizeof(int),NULL,NULL);
    ...
    // TODO:Kernel argumentumok beállítása
    clSetKernelArg(kernel, 0, sizeof(cl_mem), (void*)&device_global_histogram);
    clSetKernelArg(kernel, 1, sizeof(cl_mem), (void*)&text);
    ...
    // TODO:átadás a device-nak annyi darabamennyi bemenő adat van
    clEnqueueWriteBuffer(
        command_queue,
        device_text,
        CL_TRUE,
        0,
        txt_length*sizeof(char),
        text,
        0,
        NULL,
        NULL
